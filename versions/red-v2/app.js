...
(function(){
  ...
  var KB=[
    ...
    {kw:['услуг','испытан','анализ','лаборатор','помож','что вы','что делает','перечень','каталог','микробиолог','показател'],a:'Институт проводит <b>испытания и экспертизу кондитерской продукции</b>: физико-химия, микробиология, органолептика, идентификация, сроки годности, КТ-контроль структуры, разработку ТУ/ТИ и обучение.',link:['Каталог услуг','uslugi.html']},
  ...
  var SUGG=['Что такое КТ-морфометрия?','Как обосновать срок годности?','Сколько стоит обучение?','Что есть в библиотеке?','Как заказать услугу?'];
